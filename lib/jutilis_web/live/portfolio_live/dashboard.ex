          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="rounded-2xl border-2 border-base-300 bg-base-100 p-6">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm font-semibold text-base-content/60">Ventures</p>
                </div>
              </div>
            </div>
            ...
            <div class="rounded-2xl border-2 border-base-300 bg-base-100 p-6">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <p class="text-3xl font-black text-base-content">{@pitch_deck_count}</p>
                  <p class="text-sm font-semibold text-base-content/60">Pitch Decks</p>
                </div>
              </div>
            </div>
            ...
            <div class="rounded-2xl border-2 border-base-300 bg-base-100 p-6">
              <div class="flex items-center gap-4">
                <div class={"flex h-12 w-12 items-center justify-center rounded-xl #{if @portfolio.status == "published", do: "bg-success/20", else: "bg-warning/20"}"}>
                  <svg
                    class={"h-6 w-6 #{if @portfolio.status == "published", do: "text-success", else: "text-warning"}"}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div>
                  <p class="text-lg font-black text-base-content capitalize">{@portfolio.status}</p>
                  <p class="text-sm font-semibold text-base-content/60">Portfolio Status</p>
                </div>
              </div>
            </div>
          </div>
