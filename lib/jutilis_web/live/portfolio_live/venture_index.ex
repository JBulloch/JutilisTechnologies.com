defmodule JutilisWeb.PortfolioLive.VentureIndex do
      ...
      <div class="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <div class="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 class="text-3xl font-black text-base-content">My Ventures</h1>
            <p class="text-base-content/70 mt-1">Manage ventures in your portfolio</p>
          </div>
          <%= if @portfolio do %>
              ...
              <%= for venture <- @ventures do %>
                ...
                >
                  ...
                  <div class="flex items-center gap-2 pt-4 border-t border-base-300">
                    <.link
                      navigate={~p"/portfolio/ventures/#{venture}/edit"}
  ...
  def mount(_params, _session, socket) do
    ...
    ventures =
      if portfolio do
        Ventures.list_ventures_for_portfolio(portfolio.id)
      else
        []
      end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    case Ventures.delete_venture_for_portfolio(socket.assigns.portfolio.id, venture) do
      {:ok, _} ->
        ventures = Ventures.list_ventures_for_portfolio(socket.assigns.portfolio.id)
      ...
      {:error, _} ->
        {:noreply, put_flash(socket, :error, "Could not delete venture")}
    end
  end
end
